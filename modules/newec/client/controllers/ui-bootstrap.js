...
materialAdmin
    ...
    .controller('salutationCtrl', function ($scope) {
        $scope.items = ['Mr','Ms'];
    })
	...
	.controller('appointmentModalCtrl', function ($scope, $modal, $log) {

        $scope.modalContent = '';
//        $scope.modalContent = '<div id="popup" style="border-radius:5px;"> <div class="popuptitle">Create Appointment</div><div id="popAppointmentBodyDiv" class="popupcontent"><span id="appointmentError" class="errorboldpop"></span><form id="createAppointment" name="createAppointment" method="post" action="#" onsubmit="return makeAppointment();"> <br/><p>Fields marked with <span class="required">*</span> are required</p> <label class="pop">Name :</label><input type="text" id="apptName" style="width:150px;" /> <div class="clear">&nbsp;</div><label class="pop">Phone number :<span class="required">*</span><br/><span class="smallpop">Enter without country code (eg.4696540050)</span></label><input type="text" id="apptPhone" style="width:150px;" /> <div class="clear">&nbsp;</div><span id="apptPhoneError" class="errorpop"></span> <div class="clear">&nbsp;</div><label class="pop">Email :<span class="required">*</span></label><input type="text" id="apptEmail" style="width:150px;" /><div class="clear">&nbsp;</div><span id="apptEmailError" class="errorpop"></span><div class="clear">&nbsp;</div><label class="pop">Date :<span  class="required">*</span></label><div data-date-viewmode="years" data-date-format="dd/mm/yyyy" data-date="" class="input-append date date-picker"><input id="apptDate" name="apptDate" readOnly="readOnly" type="text" style="width:150px;" value="" class=" m-ctrl-medium date-picker"></div><div class="clear">&nbsp;</div><span id="apptDateError" class="errorpop"></span><div class="clear">&nbsp;</div><label class="pop">Time :<span class="required">*</span></label><div class="input-append bootstrap-timepicker-component"><input id="apptTime" name="apptTime" readOnly="readOnly" value="<?php echo date(h:i A,$defaultTime); ?>" type="text" class=" m-ctrl-small timepicker-default" style="width:150px;"><span class="add-on cal-icon"><i class="icon-time"></i></span></div><div class="clear">&nbsp;</div><span id="apptTimeError" name="apptTimeError" class="errorpop"></span><div class="clear">&nbsp;</div><label class="pop">Notes :</label><div class="clear">&nbsp;</div><textarea maxlength="1000" onkeyup="return imposeMaxLength(this);" id="apptNotes" class="notes diagnosticsNotes" style="margin-top:10px;"></textarea><div class="clear">&nbsp;</div><div style="text-align:center"><button type="submit" class="btn button">Done</button><button class="btn button" type="button"  onclick="removePop()"/ />Cancel</button><br/></form></div></div></div></div>';

//		$scope.$scope.time1 = new Date();
//		$scope.showMeridian1 = 'ddd';
//		$scope.disabled = true;
